...
Panel {
        ...
        Item {
          ...
          Column {
            ...
            Item {
              ...
              Row {
                id: composeActionRow
                visible: !root.composing && root.selected
                anchors.right: parent.right
                anchors.verticalCenter: parent.verticalCenter
                spacing: Style.space(4)
            ...
            Text {
              visible: root.liveMail && root.composeFromLabel !== ""
              width: parent.width
              text: "From  " + root.composeFromLabel
              color: root.dim
              font.family: root.contentFontFamily
              font.pixelSize: Style.font.bodySmall
            ...
            Column {
              ...
              Row {
                ...
                Item {
                  ...
                  height: composeToField.implicitHeight
                  ...
                  TextField {
                    ...
                    onTextChanged: {
                      root.composeTo = text
                      root.composeSuggestHidden = false
                      root.markComposeDirty()
                    }
                    onAccepted: {
                      if (root.composeSuggestCanAccept()) root.acceptComposeSuggest()
                      else root.focusComposeAddrNext("to")
                    }
                    Keys.onPressed: function(event) { root.handleComposeAddrKey(event) }
                  }
                }

                Row {
                  id: ccBccBtns
                  visible: !root.composeShowCc || !root.composeShowBcc
                  spacing: Style.space(10)
                  anchors.verticalCenter: parent.verticalCenter

                  Text {
                    visible: !root.composeShowCc
                    text: "Cc"
                    color: ccBtnMouse.containsMouse ? root.contentForeground : root.dim
                    font.family: root.contentFontFamily
                    font.pixelSize: Style.font.body
                    MouseArea {
                      id: ccBtnMouse
                      ...
                      onClicked: root.openComposeCc()
                    }
                  }

                  Text {
                    visible: !root.composeShowBcc
                    text: "Bcc"
                    color: bccBtnMouse.containsMouse ? root.contentForeground : root.dim
                    font.family: root.contentFontFamily
                    font.pixelSize: Style.font.body
                    MouseArea {
                      id: bccBtnMouse
              ...
              Item {
                ...
                visible: root.composeShowCc
                width: parent.width
                height: visible ? composeCcField.implicitHeight : 0
                ...
                TextField {
                  ...
                  onAccepted: {
                    if (root.composeSuggestCanAccept()) root.acceptComposeSuggest()
                    else root.focusComposeAddrNext("cc")
                  }
                  Keys.onPressed: function(event) { root.handleComposeAddrKey(event) }
                }
              }
              ...
              Item {
                ...
                visible: root.composeShowBcc
                width: parent.width
                height: visible ? composeBccField.implicitHeight : 0

                TextField {
                  id: composeBccField
                  width: parent.width
                  placeholderText: "Bcc"
                  text: root.composeBcc
                  foreground: root.contentForeground
                  font.family: root.contentFontFamily
                  onTextChanged: {
                    root.composeBcc = text
                    root.composeSuggestHidden = false
                    root.markComposeDirty()
                  }
                  onAccepted: {
                    if (root.composeSuggestCanAccept()) root.acceptComposeSuggest()
                    else root.focusComposeAddrNext("bcc")
                  }
                  Keys.onPressed: function(event) { root.handleComposeAddrKey(event) }
                }
              }
              ...
              Popup {
                id: composeSuggestPopup
                parent: addrBlock
                x: 0
                y: {
                  var gap = Style.spacing.xxs
                  if (composeCcField.activeFocus)
                    return toRow.height + addrBlock.spacing + ccWrap.height + gap
                  if (composeBccField.activeFocus) {
                    var top = toRow.height + addrBlock.spacing
                    if (ccWrap.visible) top += ccWrap.height + addrBlock.spacing
                    return top + bccWrap.height + gap
                  }
                  return toRow.height + gap
                }
                width: composeToField.activeFocus ? composeToField.width : addrBlock.width
                padding: Style.spacing.hairline
                focus: false
                modal: false
                visible: root.composePane && !root.composeSuggestHidden && root.composeMatches.length > 0
                  && (composeToField.activeFocus || composeCcField.activeFocus || composeBccField.activeFocus)
                ...
                contentItem: ListView {
                  ...
                  boundsBehavior: Flickable.StopAtBounds
                  model: root.composeMatches
                  currentIndex: root.composeSuggestIndex
                  ...
                  delegate: Item {
                    ...
                    Rectangle {
                      anchors.fill: parent
                      color: index === root.composeSuggestIndex
                    ...
                    MouseArea {
                      anchors.fill: parent
                      hoverEnabled: true
                      onEntered: root.composeSuggestIndex = index
                      onPressed: function(mouse) {
                        root.composeSuggestIndex = index
                        root.acceptComposeSuggest()
                        var field = root.composeAddrField(root.composeAddrRole)
            ...
            TextField {
              ...
              text: root.composeSubject
              foreground: root.contentForeground
              font.family: root.contentFontFamily
              onTextChanged: {
                root.composeSubject = text
                root.markComposeDirty()
              }
              Keys.onPressed: function(event) { root.handleEditorKey(event, root.sendCompose) }
            }
            ...
            BodyField {
              ...
              text: root.composeBody
              onTextChanged: {
                root.composeBody = text
                root.markComposeDirty()
              }
              Keys.onPressed: function(event) { root.handleEditorKey(event, root.sendCompose) }
            }
            ...
            Row {
              ...
              Button {
                text: mail.saving ? "Saving…" : "Save Draft"
                foreground: root.contentForeground
                enabled: !root.composeBusy()
              ...
              Text {
                anchors.verticalCenter: parent.verticalCenter
                text: mail.sendError !== "" ? mail.sendError : "Ctrl+Enter send · Ctrl+S draft"
        ...
        Item {
          ...
          Column {
            ...
            BorderSurface {
              ...
              Text {
                visible: root.settingsAccounts.length === 0
                anchors.centerIn: parent
          ...
          Flickable {
            ...
            Column {
              ...
              Row {
                ...
                Text {
                  text: root.editing.name || "New account"
                  color: root.contentForeground
                  font.family: root.contentFontFamily
                  font.pixelSize: Style.font.heading
                  font.bold: true
              ...
              TextField {
                ...
                foreground: root.contentForeground
                font.family: root.contentFontFamily
                onTextChanged: root.patchEditing("name", text)
                Keys.onPressed: root.handleSettingsKey(event)
              }

              FieldLabel { text: "From name" }
              TextField {
                id: accFromNameField
                width: parent.width
              ...
              TextField {
                ...
                foreground: root.contentForeground
                font.family: root.contentFontFamily
                onTextChanged: root.patchEditing("email", text)
                Keys.onPressed: root.handleSettingsKey(event)
              }
              ...
              TextField {
                ...
                foreground: root.contentForeground
                font.family: root.contentFontFamily
                onTextChanged: root.patchEditing("imapHost", text)
                Keys.onPressed: root.handleSettingsKey(event)
              }
              ...
              Row {
                ...
                TextField {
                  ...
                  foreground: root.contentForeground
                  font.family: root.contentFontFamily
                  onTextChanged: root.patchEditing("imapPort", text)
                  Keys.onPressed: root.handleSettingsKey(event)
                }
                ...
                FilterChip {
                  ...
                  selected: root.editing.imapTls !== false
                  onPicked: root.patchEditing("imapTls", !selected)
                }
              }
              ...
              TextField {
                ...
                foreground: root.contentForeground
                font.family: root.contentFontFamily
                onTextChanged: root.patchEditing("smtpHost", text)
                Keys.onPressed: root.handleSettingsKey(event)
              }
              ...
              Row {
                ...
                TextField {
                  ...
                  foreground: root.contentForeground
                  font.family: root.contentFontFamily
                  onTextChanged: root.patchEditing("smtpPort", text)
                  Keys.onPressed: root.handleSettingsKey(event)
                }
                ...
                FilterChip {
                  ...
                  selected: root.editing.smtpTls !== false
                  onPicked: root.patchEditing("smtpTls", !selected)
                }
              }
              ...
              TextField {
                ...
                foreground: root.contentForeground
                font.family: root.contentFontFamily
                onTextChanged: root.patchEditing("username", text)
                Keys.onPressed: root.handleSettingsKey(event)
              }
              ...
              TextField {
                ...
                foreground: root.contentForeground
                font.family: root.contentFontFamily
                onTextChanged: root.patchEditing("password", text)
                Keys.onPressed: root.handleSettingsKey(event)
              }
              ...
              Row {
                ...
                Button {
                  text: "Remove"
                  foreground: root.contentForeground
                  onClicked: root.removeSettingsAccount()
                }

                Text {
                  visible: root.editingDirty && !Model.accountCanSave(root.editing)
                  anchors.verticalCenter: parent.verticalCenter
  ...
  component AccountWellRow: CursorSurface {
    property var account
    property int rowIndex: 0
    readonly property bool isSelected: root.settingsAccountId === account.id
    readonly property bool dirty: root.accountDirty(account.id)
    ...
    MouseArea {
      ...
      hoverEnabled: true
      cursorShape: Qt.PointingHandCursor
      onEntered: root.selectSettingsAccount(account.id)
      onClicked: root.selectSettingsAccount(account.id)
    }
  ...
  component MailboxPicker: Item {
    ...
    function currentOption() {
      return options[indexOfValue(root.mailboxId)]
    }
    ...
    BorderSurface {
      ...
      Popup {
        ...
        onOpened: {
          optionList.currentIndex = picker.indexOfValue(root.mailboxId)
  ...
  component MailFlickable: Flickable {
    id: flick
  ...
  component FilterChip: BorderSurface {
    ...
    implicitHeight: root.filterChipHeight
    radius: Style.cornerRadius
    color: hovered
      ? Style.hoverFillFor(root.contentForeground, Color.accent)
  ...
  component ConversationRow: CursorSurface {
    property var conversation
    property int rowIndex: 0
    readonly property bool isSelected: root.selectedId === conversation.id
    ...
    MouseArea {
      ...
      onClicked: {
        root.paneFocus = "list"
        root.composeHold = false
        root.suppressSelection = false
        root.listCursorTouched = true
        root.selectedId = conversation.id
        root.openSelected()
      }
    }
    ...
    Column {
      ...
      Item {
        ...
        Rectangle {
          ...
          anchors.verticalCenter: parent.verticalCenter
          color: {
            var flags = root.mailUnreadFlags
        ...
        Text {
          ...
          anchors.right: parent.right
          anchors.verticalCenter: parent.verticalCenter
          text: Model.formatWhen(conversation.when, root.nowMs)
          color: root.dim
          font.family: root.contentFontFamily
          font.pixelSize: Style.font.caption
        }
        ...
        Text {
          ...
          anchors.verticalCenter: parent.verticalCenter
          text: {
            var _fg = root.contentForeground
            var _dim = root.dim
            var _accent = Color.accent
            return root.participantMarkup(conversation)
          }
  ...
  component ThreadMessage: Column {
    ...
    readonly property bool expanded: {
      var ids = root.expandedIds
      return isLatest || ids[root.messageKey(message, messageIndex)] === true
    }
    readonly property string address: root.messageAddress(message)
    ...
    CursorSurface {
      ...
      MouseArea {
        ...
        hoverEnabled: true
        cursorShape: Qt.PointingHandCursor
        onClicked: root.toggleMessageExpanded(message, messageIndex)
      }
      ...
      Text {
        ...
        text: message.from
        color: root.senderColor(message)
        font.family: root.contentFontFamily
        font.pixelSize: Style.font.body
        font.bold: true
        elide: Text.ElideRight
        ...
        Rectangle {
          ...
          MouseArea {
            ...
            onClicked: function(mouse) {
              root.openAttachment(message, modelData, mouse.button === Qt.RightButton ? "save" : "open")
            }
          }
  ...
  component BodyField: Item {
    ...
    BorderSurface {
      anchors.fill: parent
      color: Style.controlFill(area.activeFocus, area.hovered, root.contentForeground, Color.accent)
      borderSpec: Border.controlSpec(area.activeFocus ? "focus" : (area.hovered ? "hover-cursor" : "normal"), root.contentForeground, Color.accent)
      radius: Style.cornerRadius
    }
